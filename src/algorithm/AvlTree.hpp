...
template <typename ValueType, class Comparator>
auto AvlTree<ValueType, Comparator>::insert(const value_type &value) &noexcept
    -> std::pair<iterator, bool>
{
    ...
    else
    {
        ...
        // We want to update the smallest or the largest values, therefore
        // update header
...
template <typename ValueType, class Comparator>
auto AvlTree<ValueType, Comparator>::insert(value_type &&value) &noexcept
    -> std::pair<iterator, bool>
{
...
void AvlTree<ValueType, Comparator>::erase(const iterator &pos) &noexcept
{
    ...
    // We want to update the smallest or the largest values, therefore update
    // header
    if (pos == begin())
    {
